...
const TIERS=[
  ...
  {name:'Artifacts and sessions',service:'Amazon S3',what:'Amendments to the scene package, approvals, delivery receipts, a copy of every event, the suspended Strands sessions, and the sealed turnover manifest available in Handoff.',limit:'Standard storage. Only the session files expire, after 90 days. Durability figures are Amazon\'s, not something this project measured.'},
