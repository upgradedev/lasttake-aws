...
function DecisionForm({finding,scene,state,role,busy,act,index}:{finding:Finding;scene:Scene;state:RunState;role:Role;busy:boolean;act:Act;index:number}) {
