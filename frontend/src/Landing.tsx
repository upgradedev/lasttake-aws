...
export function Landing({session,busy,page,start,onNavigate}:{session:Session|null;busy:boolean;page:Page;start:()=>void;onNavigate?:(page:Page,run?:string)=>void}) {
  ...
  return <section className="landing" aria-label="Start a shoot-day review">
    <div className="landing-hero">
      ...
      <p className="landing-lede">For the script supervisor and 1st AD: before the set comes down, reconcile the script, takes and releases, record the human wrap decision, and prepare a traceable turnover for editorial. The synthetic demo has not measured time saved, avoided pickups or production cost.</p>
    ...
    <div className="landing-grid">
      ...
      <article className="panel landing-stages" aria-label="What happens">
        ...
        <ol className="stage-list">
          ...
          <li><strong>Turnover.</strong> After approval, Handoff exposes a sealed manifest and portable receipt for editorial review, with every accepted exception still visible.</li>
        </ol>
