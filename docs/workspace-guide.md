...
- The final recording is `NOT_CONFIGURED`: capture waits for the owner to approve the narration, measured timing and exact live journey. The owner reviews the resulting MP4 separately before upload.
